...
public class SkiPhoneService extends Service implements ShakeListener {
  ...
  private void disableSkiPhone() {
    ...
    try {
      ...
      Log.e(LOG_PREFIX, "Tried to disable SkiPhone, but SkiPhone wasn't " +
          "enabled.");
    }
  ...
  public void onVerticalShake() {
    ...
    case TelephonyManager.CALL_STATE_OFFHOOK:
      ...
      longButtonDown.putExtra(Intent.EXTRA_KEY_EVENT,
          new KeyEvent(0, 0, KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_HEADSETHOOK,
              0, 0, 0, 0, KeyEvent.FLAG_LONG_PRESS));
      sendOrderedBroadcast(longButtonDown,
          "android.permission.CALL_PRIVILEGED");
      Intent longButtonUp = new Intent(Intent.ACTION_MEDIA_BUTTON);               
      longButtonUp.putExtra(Intent.EXTRA_KEY_EVENT,
          new KeyEvent(0, 0, KeyEvent.ACTION_UP, KeyEvent.KEYCODE_HEADSETHOOK,
              0, 0, 0, 0, KeyEvent.FLAG_LONG_PRESS));
  ...
  private void showNotification() {
    ...
    PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
            new Intent(this, SkiPhone.class), 0);

    // Set the info for the views that show in the notification panel.
    notification.setLatestEventInfo(this, text, getText(R.string.notification),
                   contentIntent);
